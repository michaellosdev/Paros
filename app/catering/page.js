    ...
    <div className="flex h-fit w-full flex-col items-center ">
      ...
      <div className="flex h-fit w-full flex-col items-center justify-center py-16">
        ...
        <div className="h-fit w-[95%] lg:w-[80%]">
          ...
          <div className="darker-blue-text mb-2 flex h-8 w-full justify-end text-xl font-semibold">
            <p className="mx-4">Small</p>
            <p className="mx-2">Large</p>
          </div>
          <div className="darker-blue-text mb-2 flex h-8 w-full justify-between text-xl font-normal">
            <p>Serves</p>
