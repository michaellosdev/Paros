  ...
  return (
    <div id="main" className="flex flex-col items-center">
      ...
      >
        ...
        >
          <h1 className="darker-blue-text opa py-8 text-center text-3xl font-bold lg:text-5xl ">
            Welcome to Paros
          </h1>
          ...
          <p className="darker-blue-text mb-8 text-lg lg:text-2xl">
            ...
            Mediterranean cuisine, but for our commitment to superior service
            and warm, welcoming atmosphere. <br /> <br /> &nbsp; &nbsp; Whether
            you're joining us for a meal, picking up a takeout order, or
            utilizing our efficient delivery service, you'll enjoy a taste of
            the Mediterranean prepared with care and the freshest ingredients.
            Our friendly staff is dedicated to making your experience memorable
            with every visit or order. <br /> <br /> &nbsp; &nbsp; Paros is more
            than a restaurant; it's a family tradition and a vital part of the
            Los Angeles community. Experience the magic of Mediterranean dining
            with us today at Paros Family Restaurant.
          </p>
        ...
        <div className="dark-blue-bg flex h-fit w-full flex-col items-center justify-center py-8 text-white lg:h-[75vh] ">
          <div className="flex  w-[90%] flex-col items-center justify-center lg:w-[70%] ">
            ...
            <p className=" mb-8 text-lg lg:text-2xl">
              ...
              Paros Family Restaurant to your special events. From private
              parties to corporate gatherings, our dedicated team is ready to
              create an unforgettable Mediterranean feast for you and your
              guests. We handle all the details so you can savor the moments
              with your guests. For more information, navigate to our 'Catering'
              page or get in touch with us directly.
            </p>
